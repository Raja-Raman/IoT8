...
#define  CMD_SET_FW_SERVER_URL    3
#define  CMD_SET_DEVICE_ID        4
#define  CMD_SET_GROUP_ID         5
#define  CMD_SET_EXTRA            6   
#define  CMD_SET_INTERVAL         7  
#define  CMD_WRITE_FLASH_CONFIG   8

#define  CMD_UPDATE_FIRMWARE      9
#define  CMD_RESTART              10

#define  CMDX_PARSING_ERROR       11
#define  CMDX_EVENT_DATA          12
#define  CMDX_REGULAR_DATA        13

// CMD_SET_EXTRA is used for enabling/disabling the relay (for parking sensor, it is the threshold value)
// CMD_SET_INTERVAL is the data sending periodicity. (for parking sensor, it is the sleep duration)
// CMDX_PARSING_ERROR is generated internally by the Json/HTTP GET parser
